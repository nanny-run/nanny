...
**Scope:** All agents in the diagram run within one process. This covers any framework that orchestrates agents in a single runtime. Cross-process and cross-machine fleet enforcement is the [v0.2.0 cloud layer](https://nanny.run).
