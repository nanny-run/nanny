...
Removes the binary from its current install location. On macOS, if Nanny was installed via Homebrew, this redirects you to `brew uninstall nannyd` to keep Homebrew metadata consistent.
