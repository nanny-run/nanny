...
<Frame>
  <img
    src="https://raw.githubusercontent.com/nanny-run/nanny/next/assets/demo/metrics-crew-tool-denied.gif"
...
<Frame>
  <img
    src="https://raw.githubusercontent.com/nanny-run/nanny/next/assets/demo/metrics-crew-rule-denied.gif"
...
<Frame>
  <img
    src="https://raw.githubusercontent.com/nanny-run/nanny/next/assets/demo/metrics-crew-agent-scopes.gif"
...
<Frame>
  <img
    src="https://raw.githubusercontent.com/nanny-run/nanny/next/assets/demo/metrics-crew-budget-exhausted.gif"
...
<Frame>
  <img
    src="https://raw.githubusercontent.com/nanny-run/nanny/next/assets/demo/metrics-crew-max-steps.gif"
    alt="metrics_crew — MaxStepsReached stops the analysis agent after it exhausts its step allowance"
  />
</Frame>

<Note>
  **Scope:** All agents in this pattern run within a single Python process. This covers CrewAI, LangGraph, AutoGen, and any framework that orchestrates agents in a single runtime. Cross-process fleet enforcement is coming in v0.2.0.
</Note>
