...
- Docs are versioned at the **minor** level: `v0.3/`, `v1.0/`, etc. — never at the patch level
...
- All internal links must include the version prefix: `/v0.3/quickstart`, not `/quickstart`
