...
The Python SDK brings the same enforcement model as the [Rust SDK](/v0.3/guides/rust-sdk) to Python — `@tool`, `@rule`, and `@agent` decorators that enforce limits per function call.
...
For cross-process and cross-machine enforcement, use the [governance server](/v0.3/guides/governance-server).
