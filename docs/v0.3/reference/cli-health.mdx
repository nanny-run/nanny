...
- [`nanny server status`](/v0.3/reference/cli-server) — focused status view for the governance server
- [`nanny certs show`](/v0.3/reference/cli-certs) — cert expiry and file inventory
