...
| Rules | `@rule` in your code, or an installed [rule pack](/v0.7/guides/rule-packs) | The first rule to refuse fires `RuleDenied` and ends the run |

Both require the agent to report its tool calls, through the
[Rust SDK](/v0.7/guides/rust-sdk) macros or the [Python SDK](/v0.7/guides/python-sdk)
decorators.
