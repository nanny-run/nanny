...
- [`nanny status`](/v0.5/run#governance-server), focused status view for the governance server
- [`nanny certs show`](/v0.5/reference/cli-certs), cert expiry and file inventory
