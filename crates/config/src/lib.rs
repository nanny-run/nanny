...
///
/// Set on the governor, which uses it instead of minting one. Set on a
...
/// Shortest session token a governor will accept from an operator.
///
...
# Full reference: https://docs.nanny.run/v0.7/reference/nanny-toml
#
...
# it unset and everything still works, offline, with the event log on stdout.
#
